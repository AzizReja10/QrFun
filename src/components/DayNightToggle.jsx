...
const DayNightToggle = ({
  ...
  return (
    <StyledWrapper $size={size} className={className}>
      <label id="theme-toggle-button" htmlFor={id} title={checked ? 'Switch to Day mode' : 'Switch to Night mode'}>
        <input
          type="checkbox"
          id={id}
          checked={checked}
              ...
              <g data-name="sun" id="sun">
                ...
                <g filter="url(#sun)" transform="matrix(1, 0, 0, 1, -5.83, -5.83)">
                  <path
                    ...
                    d="M11.667,0A11.667,11.667,0,1,1,0,11.667,11.667,0,0,1,11.667,0Z"
                    data-name="sun"
                    id="sun-3"
                  />
                </g>
...
const StyledWrapper = styled.div`
  ...
  #theme-toggle-button {
    font-size: ${(props) => fontSizeMap[props.$size] || props.$size || '9px'};
    position: relative;
  ...
  input:checked + svg #container {
    fill: #2b4360;
  }

  /* move button to right when checked */
  input:checked + svg #button {
  ...
  input:checked + svg #stars {
    opacity: 1;
  }
`

export { DayNightToggle as Switch }
